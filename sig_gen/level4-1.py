...
auth_res5 = b'i=5; lists.example.org; spf=pass smtp.mfrom=jqd@d1.example; dkim=pass (1024-bit key) header.i=@d1.example; dmarc=pass'
...
arsh = lambda b, bh: [
    ...
    (b'arc-message-signature', ams4),
    (b'arc-seal', as4),
    (b'arc-authentication-results', auth_res5),
